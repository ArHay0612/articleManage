<template>
  <el-container id="app">
        ...
        <el-col :span="2" :offset="20">
          <el-dropdown @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="showUserInfo">修改信息</el-dropdown-item>
    ...
    <el-main style="height: 100%;padding:0">
      <el-container>
        <el-aside width="200px" style="background-color:#545c64;min-height:45rem;">
          <el-row>
            <el-col>
              <el-menu
    ...
    <el-dialog title="修改信息" :visible.sync="showDialog" width="20%" :before-close="handleClose">
...
export default {
  ...
  mounted() {
    ...
    console.log(Cookies.get('taxpayername'))
    this.checkMyInfo()
  },
  methods: {
    handleClose() {
